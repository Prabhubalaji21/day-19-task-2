...
// API DOCS - https://finalspaceapi.com/api/v0/

console.log("ASYNC AWAIT EXAMPLE");

const loadPokemons = async () => {
  try {
    let response = await fetch("https://finalspaceapi.com/api/v0/character? limit=50"); // Asynchronous operation - must be awaited
...
const loadPokemonsWithName = async (name) => {
  try {
    let res = await fetch("https://finalspaceapi.com/api/v0/" + name);
